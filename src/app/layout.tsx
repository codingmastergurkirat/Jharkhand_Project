...
export const metadata: Metadata = {
  title: 'Jan Samadhan | Collaborative Citizen Problem Resolution Portal',
  description: 'National collaborative governance platform connecting citizens, universities, and industries to solve societal challenges with transparent R&D allocation and CSR funding.',
};
            ...
            <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-4">
              <div>
                ...
                <p className="text-gray-400 mt-1">
                  Citizen-Centric Public Problem Resolution System. Designed in compliance with GIGW & WCAG 2.0 AA.
                </p>
